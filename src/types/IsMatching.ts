import { Primitives, IsPlainObject, IsUnion, ValueOf, Length, IsLiteral, All, Equal } from "./helpers";

type IsMatchingTuple<a extends readonly any[], b extends readonly any[]> = [a, b] extends [readonly [], readonly []]
	? true
