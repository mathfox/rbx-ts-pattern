...
export type Flatten<xs extends readonly any[], output extends any[] = []> = xs extends readonly [
	infer head,
	...infer tail,
]
...
export type Length<it extends readonly any[]> = ArrayLength<it>;

export type Iterator<n extends number, it extends any[] = []> = ArrayLength<it> extends n
	? it
	: Iterator<n, [any, ...it]>;
...
export type BuiltInObjects = Callback | Generator | any[];
...
type PropertyKey = symbol | number | string;
